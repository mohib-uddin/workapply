...
import svgPaths from "../../imports/svg-6xm1gl6or7";
import svgPathsDashboard from "../../imports/svg-hcgyk2p2de";
import svgPathsSubscription from "../../imports/svg-h4u2ypc311";
