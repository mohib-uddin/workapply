...
export default function JobQueueWelcomeTour({ open, onClose }: JobQueueWelcomeTourProps) {
                    ...
                    <div className="border-t border-[#1a1a1a] px-8 py-6">
                        ...
                        <div className="flex items-center justify-between gap-4">
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-[4px] font-['Pavanam',sans-serif] text-[14px] transition-all duration-200 ${currentStep === 0
                            ...
                            <button
                                onClick={handleNext}
                                className="px-6 py-2.5 bg-[#611DCD] hover:bg-[#722ce3] text-[#faf9f6] rounded-[4px] font-['Pavanam',sans-serif] text-[14px] font-medium transition-all duration-200"
                            >
