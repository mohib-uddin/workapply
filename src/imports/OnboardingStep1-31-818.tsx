import svgPaths from "./svg-xe3y21xm3l";
...
function LayoutTag() {
  return (
    <div className="absolute contents h-[96px] left-[1727px] top-[366px] w-[89px]" data-name="Layout tag">
      <div className="absolute flex h-[96px] items-center justify-center left-[1727px] top-[366px] w-[36px]" style={{ "--transform-inner-width": "4", "--transform-inner-height": "2" } as React.CSSProperties}>
...
function LayoutTag1() {
  return (
    <div className="absolute contents h-[96px] left-[1727px] top-[535px] w-[89px]" data-name="Layout tag">
      <div className="absolute flex h-[96px] items-center justify-center left-[1727px] top-[535px] w-[36px]" style={{ "--transform-inner-width": "4", "--transform-inner-height": "2" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="border-[#8bff7e] border-[2px_2px_0px] border-solid h-[36px] w-[96px]" />
        </div>
      </div>
