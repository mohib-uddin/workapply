import svgPaths from "./svg-cfxi51c90m";
...
function ProgressIndicator() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Progress indicator">
      ...
      <div className="[grid-area:1_/_1] bg-[#611dcd] h-[35px] ml-0 mt-0 rounded-[1px] w-[400px]" />
      <p className="[grid-area:1_/_1] font-['Pavanam:Regular',sans-serif] leading-[22px] ml-[1634.5px] mt-[7px] not-italic relative text-[20px] text-center text-nowrap text-white translate-x-[-50%]">5 of 20</p>
    </div>
  );
}
...
function Title() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Pavanam:Regular',sans-serif] gap-[12px] grow items-center min-h-px min-w-px mr-[-88px] not-italic relative shrink-0 text-center text-white" data-name="Title">
      <p className="leading-[52px] relative shrink-0 text-[52px] w-full">Which best describes your experience level?</p>
      <p className="leading-[28px] relative shrink-0 text-[28px] w-full">Please choose one of the below</p>
    </div>
  );
}
...
function RadioButton() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex items-center justify-center p-[16px] relative rounded-[4px] shrink-0" data-name="Radio Button">
      ...
      <p className="font-['Pavanam:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[40px] text-center text-nowrap text-white">{`Entry Level (<1 year)`}</p>
    </div>
  );
}
...
function RadioButton1() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex items-center justify-center p-[16px] relative rounded-[4px] shrink-0" data-name="Radio Button">
      <div aria-hidden="true" className="absolute border border-[#faf9f6] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Pavanam:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[40px] text-center text-nowrap text-white">Junior (1-3 years)</p>
    </div>
  );
}
...
function RadioButton2() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex items-center justify-center p-[16px] relative rounded-[4px] shrink-0" data-name="Radio Button">
      <div aria-hidden="true" className="absolute border border-[#faf9f6] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Pavanam:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[40px] text-center text-nowrap text-white">Mid level (3-5 years)</p>
    </div>
  );
}
...
function RadioButton3() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex items-center justify-center p-[16px] relative rounded-[4px] shrink-0" data-name="Radio Button">
      <div aria-hidden="true" className="absolute border border-[#faf9f6] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Pavanam:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[40px] text-center text-nowrap text-white">Senior level (5-8 years)</p>
    </div>
  );
}
...
function RadioButton4() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex items-center justify-center p-[16px] relative rounded-[4px] shrink-0" data-name="Radio Button">
      <div aria-hidden="true" className="absolute border border-[#faf9f6] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Pavanam:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[40px] text-center text-nowrap text-white">Lead / Principal ( 8+ years)</p>
    </div>
  );
}
...
function LayoutTag() {
  return (
    <div className="absolute contents h-[96px] left-[1720px] top-[423px] w-[89px]" data-name="Layout tag">
      <div className="absolute flex h-[96px] items-center justify-center left-[1720px] top-[423px] w-[36px]" style={{ "--transform-inner-width": "4", "--transform-inner-height": "2" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="border-[#8bff7e] border-[2px_2px_0px] border-solid h-[36px] w-[96px]" />
        </div>
      </div>
      <p className="absolute font-['Pavanam:Regular',sans-serif] leading-[28px] left-[1785.5px] not-italic text-[#8bff7e] text-[28px] text-center top-[461.02px] translate-x-[-50%] w-[47px]">96px</p>
    </div>
  );
}
...
function LayoutTag1() {
  return (
    <div className="absolute contents h-[96px] left-[1720px] top-[700px] w-[89px]" data-name="Layout tag">
      <div className="absolute flex h-[96px] items-center justify-center left-[1720px] top-[700px] w-[36px]" style={{ "--transform-inner-width": "4", "--transform-inner-height": "2" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="border-[#8bff7e] border-[2px_2px_0px] border-solid h-[36px] w-[96px]" />
        </div>
      </div>
      <p className="absolute font-['Pavanam:Regular',sans-serif] leading-[28px] left-[1785.5px] not-italic text-[#8bff7e] text-[28px] text-center top-[738.02px] translate-x-[-50%] w-[47px]">96px</p>
    </div>
  );
}
...
export default function OnboardingStep() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Onboarding step 5">
