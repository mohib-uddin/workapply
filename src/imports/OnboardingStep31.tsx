import svgPaths from "./svg-ixe1krn150";
...
function LayoutTag() {
  return (
    <div className="absolute contents h-[96px] left-[calc(50%+767px)] top-[428px] w-[89px]" data-name="Layout tag">
      <div className="absolute flex h-[96px] items-center justify-center left-[calc(50%+767px)] top-[428px] w-[36px]" style={{ "--transform-inner-width": "3", "--transform-inner-height": "2" } as React.CSSProperties}>
...
function LayoutTag1() {
  return (
    <div className="absolute contents h-[48px] left-[calc(50%+767px)] top-[674px] w-[94px]" data-name="Layout tag">
      <div className="absolute flex h-[48px] items-center justify-center left-[calc(50%+767px)] top-[674px] w-[36px]" style={{ "--transform-inner-width": "3", "--transform-inner-height": "2" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
...
function LayoutTag2() {
  return (
    <div className="absolute contents h-[96px] left-[calc(50%+759px)] top-[783px] w-[89px]" data-name="Layout tag">
      <div className="absolute flex h-[96px] items-center justify-center left-[calc(50%+759px)] top-[783px] w-[36px]" style={{ "--transform-inner-width": "3", "--transform-inner-height": "2" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="border-[#8bff7e] border-[2px_2px_0px] border-solid h-[36px] w-[96px]" />
        </div>
      </div>
